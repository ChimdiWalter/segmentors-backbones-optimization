...
OUTPUT_DIR = '/deltos/e/lesion_phes/code/python/pipeline/segmentors_backbones/navier_output_2'
...
def snake_seg(image_u8, energy_u8, its, alpha, beta, gamma, l_size, u_size, energy_threshold):
    ...
    for rgn in props:
        ...
        # 200-point circular init (keep same)
...
# ---------------- FUSED channel (G, GRAY, Lab a*) + masked CLAHE ----------------
def fused_channel_u8(bgr8, binary_mask=None):
    ...
    # Lift midtones on leaf region only
...
def process_single_image(filename):
    ...
    try:
        ...
        # Precompute gradients once for fused channel
        _, gx, gy = gradient_magnitude(fused_u8)
...
def process_images_with_grid_search(input_dir, output_dir, log_csv="results_log.csv"):
    ...
    print("========== navier FUSED (G+GRAY+Lab a*) GRID PARALLEL ==========")
...
def main():
    # Optional CLI: python3 navier_fused_10combos_parallel.py [INPUT_DIR] [OUTPUT_DIR]
    ...
    process_images_with_grid_search(in_dir, out_dir, LOG_NAME)
