...
The images exhibit necrotic spots, chlorotic halos, coalescing lesions, and variable contrast.
...
The stochastic optimizer converged to a stable segmentation mask in a large fraction of images, with failures typically due to glare, extreme low-contrast, or absent lesions.
\TODO{Insert actual convergence \%, and show a table of failure modes.}
