...
% --- figure search paths ---
\graphicspath{{figs/}{figs/exp_v1/}{figs_9leaf/}}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs/exp_v1/optimizer_status_bar.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs/exp_v1/optimizer_elapsed_seconds_hist.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs/exp_v1/optimizer_score_hist.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs/exp_v1/threshold_sweep_plot.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs/exp_v1/scatter_energy_threshold_vs_lesion_count.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs/exp_v1/scatter_beta_vs_area_frac.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs_9leaf/surface_DSC_0198_segment_1_segmented_smoothed__surface_energy_threshold_vs_beta.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs_9leaf/surface_DSC_0379_segment_1_segmented_smoothed__surface_energy_threshold_vs_beta.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs_9leaf/surface_DSC_0261_segment_1_segmented_smoothed__surface_energy_threshold_vs_beta.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figs_9leaf/traj_DSC_0198_segment_1_segmented_smoothed__trajectory_best_score_so_far.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figs/exp_v1/hist_area_frac_error.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figs/exp_v1/hist_count_error.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figs/exp_v1/scatter_teacher_vs_pred_area_frac.png}
...
\centering
\includegraphics[width=\linewidth]{figs/exp_v1/n_contours_hist.png}
\caption*{(a) Connected-component count ($n_c$) distribution.}
\end{minipage}\hfill
\begin{minipage}[b]{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{figs/exp_v1/area_px_hist.png}
...
\includegraphics[width=\linewidth]{figs/exp_v1/param_mu_hist.png}\caption*{(a) $\mu$}\end{minipage}\hfill
\begin{minipage}[b]{0.32\textwidth}\centering
\includegraphics[width=\linewidth]{figs/exp_v1/param_lambda_hist.png}\caption*{(b) $\lambda$}\end{minipage}\hfill
\begin{minipage}[b]{0.32\textwidth}\centering
\includegraphics[width=\linewidth]{figs/exp_v1/param_diffusion_rate_hist.png}\caption*{(c) diffusion}\end{minipage}

\vspace{2mm}

\begin{minipage}[b]{0.32\textwidth}\centering
\includegraphics[width=\linewidth]{figs/exp_v1/param_alpha_hist.png}\caption*{(d) $\alpha$}\end{minipage}\hfill
\begin{minipage}[b]{0.32\textwidth}\centering
\includegraphics[width=\linewidth]{figs/exp_v1/param_beta_hist.png}\caption*{(e) $\beta$}\end{minipage}\hfill
\begin{minipage}[b]{0.32\textwidth}\centering
\includegraphics[width=\linewidth]{figs/exp_v1/param_gamma_hist.png}\caption*{(f) $\gamma$}\end{minipage}

\vspace{2mm}

\begin{minipage}[b]{0.49\textwidth}\centering
\includegraphics[width=\linewidth]{figs/exp_v1/param_energy_threshold_hist.png}
...
\begin{minipage}[b]{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{figs_9leaf/traj_DSC_0166_segment_1_segmented_smoothed__trajectory_best_score_so_far.png}
\caption*{(a) High-score leaf (DSC\_0166): convergence.}
\end{minipage}\hfill
\begin{minipage}[b]{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{figs_9leaf/traj_DSC_0163_segment_1_segmented_smoothed__trajectory_best_score_so_far.png}
...
\begin{minipage}[b]{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{figs_9leaf/traj_DSC_0274_segment_1_segmented_smoothed__trajectory_best_score_so_far.png}
\caption*{(a) Median-score leaf (DSC\_0274): convergence.}
\end{minipage}\hfill
\begin{minipage}[b]{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{figs_9leaf/traj_DSC_0205_segment_1_segmented_smoothed__trajectory_best_score_so_far.png}
...
\begin{minipage}[b]{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{figs_9leaf/traj_DSC_0185_segment_1_segmented_smoothed__trajectory_best_score_so_far.png}
\caption*{(a) Low-score leaf (DSC\_0185): convergence.}
\end{minipage}\hfill
\begin{minipage}[b]{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{figs_9leaf/traj_DSC_0199_segment_1_segmented_smoothed__trajectory_best_score_so_far.png}
