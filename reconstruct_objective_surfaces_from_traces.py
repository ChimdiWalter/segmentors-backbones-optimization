#!/usr/bin/env python3
"""Reconstruct objective surfaces/trajectories from true candidate trace CSVs."""
...
def parse_args():
    ...
    p.add_argument(
        "--root",
        default="experiments/exp_v1/outputs/objective_surface_traces_fullstudy",
        help="Output root for this study",
    )
    return p.parse_args()
...
def main():
    ...
    selected_txt = root / "selected_cases.txt"
    ...
    summary_df.to_csv(root / "surface_case_summary.csv", index=False)
