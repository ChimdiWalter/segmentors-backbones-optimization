...
OUTPUT_DIR = '/deltos/e/lesion_phes/code/python/pipeline/segmentors_backbones/navier_output_fused_auto_tiled'
...
def process_single_image(filename):
    """Process one image for all COMBOS with tiling; return CSV rows list."""
    try:
        ...
        # Auto thresholds (once per image)
        grad_mag_u8, _, _ = gradient_magnitude(masked_fused)
        ...
        for (mu, lam, dr, alpha, beta, gamma) in COMBOS:
            ...
            try:
                ...
                rows.append([filename, mu, lam, dr, alpha, beta, gamma,
...
def process_images_with_grid_search(input_dir, output_dir, log_csv="results_log.csv"):
    ...
    print("========== navier_fused AUTO TILED PARALLEL DEBUG ==========")
