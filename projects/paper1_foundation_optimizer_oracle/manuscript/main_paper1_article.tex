...
\begin{itemize}
    ...
    \item U-Net trained on a small labeled subset \citep{ronneberger2015u}.
    \item A modern segmentation pipeline initialized with strong encoders (e.g., SegFormer \citep{xie2021segformer}, SAM \citep{kirillov2023segment}) for weak supervision.
\end{itemize}
